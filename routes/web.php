...
Route::get('projectestimation-edit/{project_id}/{tcode}', [ProjectEstimationController::class, 'editProjectEstimation'])->name('editProjectEstimation');
...
Route::post('/update-activities', [ActivitiesController::class, 'updateActivities'])->name('updateActivities');
...
Route::get('/items/add', function () {
    return view('frontend.items.add');
});
Route::get('/searchitems/{key}', [ItemsController::class, 'search']);
...
Route::get('/searchSubActivity/{id}', [ActivitiesController::class, 'searchSubActivity']);
