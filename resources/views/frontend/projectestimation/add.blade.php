    ...
    <div class="card card-info">
        ...
        <form action="{{route('postProjectActivitiesData')}}" method="POST">
            ...
            <div class="card-footer">
                <input type="button" value="Save Data" onclick="saveDataIntoTable();" class="btn btn-info float-sm-left">
                </button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content ">
            <div class="modal-header bg bg-info">
                <h5 class="modal-title" id="exampleModalLongTitle">Sub Item List</i></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <a href="#" id="deleteItem" class="btn btn-info">Save</a>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function changeitemQtyCredit(textField) {
        if (textField == 'itemQty') {
            $('#credit').val('');
        } else {
            $('#itemQty').val('');
        }
