            ...
            <div class="card-body">
                ...
                <div style="border-bottom:red" class="form-group row">
                    ...
                    <div class="col-sm-1">
                        ...
                        <input type="text" class="form-control" value="{{@$data[0]->id}}" readonly id="billNo"
                            name="billNo" />
                    </div>
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" autocomplete="off" value="{{$data[0]->customer_name}}" class="form-control"
                            name="searchKey" onkeyup="searchCustomer();" id="searchKey" placeholder="Customer Name">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" autocomplete="off" class="form-control"
                            value="{{$data[0]->customer_address}}" id="customerAddress" placeholder="Customer Address">

                    </div>

                    <div class="col-sm-3">
                        <label for="status" class=" col-form-label">Contact:*</label> <input type="text"
                            autocomplete="off" class="form-control" value="{{$data[0]->customer_phonenumber}}"
                            id="customerContact" placeholder="Customer Contact Number">
                    </div>
                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <form>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" autocomplete="off" class="form-control"
                                            name="searchKeyForService" onkeyup="searchService();"
                                            id="searchKeyForService" placeholder="Search service">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <input type="number" id="quantity" autocomplete="off" class="form-control"
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" autocomplete="off" class="form-control" id="service_rate"
                                            placeholder="Service Rate">
                                    </div>
                                    <div class="col-sm">
                                        <input type="button" value="Add" onclick="addItemIntoBasket();"
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" readonly id="total" value="{{$data[0]->totalamount}}" autocomplete="off"
                            class="form-control">
                    </div>

                    <div class="col-sm-3">
                        <label for="status" class=" col-form-label">Discount:</label>
                        <input type="text" id="discount" value="{{$data[0]->discount}}" onkeyup="calculate();"
                            autocomplete="off" class="form-control">
                    </div>

                    <div class="col-sm-3">
                        <label for="status" class=" col-form-label">All Total:</label>
                        <input type="text" autocomplete="off" id="alltotal" value="{{$data[0]->alltotalamount}}"
...
items.push('{{$item->service_name}}' + '{#}' + '{{$item->service_id}}' + '{#}' + '{{$item->quantity}}' + '{#}' +
    '{{$item->service_rate}}');
</script>
@endforeach
...
function calculate() {
    document.getElementById('alltotal').value = parseFloat(document.getElementById('total').value - parseFloat(document
...
function displayBasketItemIntoTable() {
    ...
    for (let i = 0; i < items.length; i++) {
        ...
        var str = '<tr><td>' + items[i].split("{#}")[0] + '</td><td>' + items[i].split("{#}")[2] + '</td><td>' + items[
                i].split("{#}")[3] + '</td><td onclick="removeItem(\'' + items[i] +
            '\')"> <i class="fas fa-remove"></i></td></tr>';
            ...
            success: function(dataResult) {
                ...
                for (var i = 0; i < dataResult.length; i++) {
                    ...
                    var str = "<a href='#' onclick='putItemIntoTextField(" + dataResult[i].id + ",\"" +
                        dataResult[i].customer_name + "\",\"" + dataResult[i].customer_address + "\",\"" +
                        dataResult[i].customer_phonenumber + "\");'>" + dataResult[i].customer_name +
        ...
        $.ajax({
            ...
            success: function(dataResult) {
                ...
                for (var i = 0; i < dataResult.length; i++) {
                    ...
                    var str = "<a href='#' onclick='putItemIntoTextFieldFromService(" + dataResult[i].id +
                        ",\"" + dataResult[i].service_name + "\",\"" + dataResult[i].service_rate +
                        "\");'>" + dataResult[i].service_name + " - " + dataResult[i].service_rate + "</a>";
