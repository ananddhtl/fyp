        ...
        <table class="table table-hover text-nowrap">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td> Rs {{ $currancyformat->moneyFormatIndia($servicebillamount ->totalamount)  }}</td>

              <td>Rs {{ $currancyformat->moneyFormatIndia($servicebillamount ->discount) }}</td>
              <td>Rs {{ $currancyformat->moneyFormatIndia($servicebillamount ->alltotalamount) }} </td>
