            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                        ...
                        <input type="date" class="form-control" autocomplete="off" name="date" id="startDate"
                            placeholder="" required>
                    </div>


                    <div class="col-sm-8">
                        <label for="status" class=" col-form-label">Full name:*</label>

                        <input type="hidden" class="form-control" name="staff_id" id="staff_id">
                        <input type="text" class="form-control" autocomplete="off" name="StaffName"
                            onkeyup="searchStaff();" id="StaffName" placeholder="Enter Staff Name" required>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <input type="number" class="form-control" autocomplete="off" name="amount" id="amount"
                            placeholder="Enter Amount" required>
                    </div>
                    <div class="col-sm-6">
                        <label for="amount" class=" col-form-label"> Remarks:*</label>

                        <input type="text" class="form-control" autocomplete="off" name="narration" id="narration"
            ...
            success: function(dataResult) {
                ...
                for (var i = 0; i < dataResult.length; i++) {
                    ...
                    var str = "<a href='#' onclick='putItemIntoTextField(" + dataResult[i].id + ",\"" +
                        dataResult[i].staff_name + "\");'>" + dataResult[i].staff_name + " - " + dataResult[
                            i].staff_phonenumber + "</a>";
