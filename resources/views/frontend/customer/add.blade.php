            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control " autocomplete="off" name="customer_name"
                            id="customer_name" placeholder="Enter Full Name" required>

                    </div>
                    <div class="col-sm-6">
                        <label for="customer_address" class=" col-form-label"> Address:*</label>

                        <input type="text" class="form-control" autocomplete="off" name="customer_address"
                            id="customer_address" placeholder="Enter Address" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <input type="email" class="form-control" autocomplete="off" name="customer_email"
                            id="customer_email" placeholder="Enter Email">
                    </div>
                    <div class="col-sm-6">
                        <label for="customer_phonenumber" class="col-form-label">Contact No:*</label>

                        <input type="number" class="form-control" autocomplete="off" name="customer_phonenumber"
                            id="customer_phonenumber" placeholder="Enter Contact Number" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" autocomplete="off" name="customer_profession"
                            id="customer_profession" placeholder=" Enter Customer Profession">
                    </div>
                </div>
