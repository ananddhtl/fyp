      ...
      <div class="card-body">
        <div class="form-group row">
          ...
          <div class="col-sm-3">
            ...
            <input type="date" id="billDate" class="form-control" readonly name="billDate" value="2022-09-26" />
          </div>
        ...
        <div style="border-bottom:red" class="form-group row">
          ...
          <div class="col-sm-3">
            ...
            <input type="text" autocomplete="off" readonly value="{{$data[0]->customer_name}}" class="form-control" name="searchKey" onkeyup="searchCustomer();" id="searchKey" placeholder="Customer Name">
          ...
          <div class="col-sm-3">
            ...
            <input type="text" autocomplete="off"  readonly class="form-control" value="{{$data[0]->customer_address}}" id="customerAddress" placeholder="Customer Address">

          </div>

          <div class="col-sm-3">
            <label for="status" class=" col-form-label">Contact No.:</label>
            <input type="text" autocomplete="off" readonly class="form-control" value="{{$data[0]->customer_phonenumber}}" id="customerContact" placeholder="Customer Contact Number">
          </div>
        </div>
