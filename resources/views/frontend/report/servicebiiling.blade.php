                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Rs {{ $currancyformat->moneyFormatIndia($item ->totalamount)  }}</td>

                                <td>Rs {{ $currancyformat->moneyFormatIndia($item ->discount) }}</td>
                                <td>Rs {{ $currancyformat->moneyFormatIndia($item ->alltotalamount) }} </td>
                            ...
                            <tr>
                                ...
                                <th>Rs {{ $currancyformat->moneyFormatIndia($totaldiscount) }} </th>
