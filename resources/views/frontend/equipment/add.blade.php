        ...
        <form action="{{route('equipmentadd')}}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="equipment_name" class="col-form-label">Name:* </label>
                        <input type="text" class="form-control " autocomplete="off" name="equipment_name"
                            id="equipment_name" placeholder="Enter  Name" required>
                    </div>
                    <div class="col-sm-6">
                        <label for="purchase_rate" class="col-form-label">Buying Rate:*</label>
                        <input type="number" class="form-control" autocomplete="off" name="purchase_rate"
                            id="purchase_rate" placeholder="Enter Rate" required>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="equipment_cat_id" class="col-form-label">Catagory:*</label>
                        <select class="form-control select3 select2-danger" name="equipment_cat_id"
