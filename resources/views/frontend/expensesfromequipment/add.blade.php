                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="text" class="form-control" autocomplete="off" name="EquipmentName"
                            onkeypress="searchEquipment();" id="EquipmentName" placeholder="Enter Equipment Name"
                            required>
                ...
                <div class="form-group row">
                    <div class="col-sm-8">
                        ...
                        <input type="text" class="form-control" autocomplete="off" name="searchKey"
                            onkeypress="searchCustomer();" id="searchKey" placeholder="Enter Customer Name" required>
        ...
        $.ajax({
            ...
            success: function(dataResult) {
                ...
                for (var i = 0; i < dataResult.length; i++) {
                    ...
                    var str = "<a href='#' onclick='putItemIntoTextFieldFromEquipment(" + dataResult[i].id +
                        ",\"" + dataResult[i].equipment_name + "\");'>" + dataResult[i].equipment_name +
                        " - " + dataResult[i].purchase_rate + "</a>";
