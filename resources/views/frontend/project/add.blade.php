        ...
        <form action="{{route('postProjectData')}}" method="POST">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <label for="project_address" class=" col-form-label"> Location:*</label>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="project_city" class="col-form-label"> City:*</label>
                    ...
                    <div class="col-sm-6">
                    <label for="project_duration" class=" col-form-label"> Duration:*</label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <label for="status" class=" col-form-label">Project Leader:*</label>
                    ...
                    <div class="col-sm-6">
                        <label for="status" class="col-form-label">Customer Name:*</label>
                ...
                <div class="form-group row">
                <div class="col-sm-6">
                    <label for="project_duration" class=" col-form-label">Cost Estimation:*</label>
                    <h1 style="font-size:15px;">(Click for cost estimation of a project)</h1>
                    ...
                    <div class="col-sm-6">
                    <label for="project_fiscal_year" class=" col-form-label"> Fiscal Year:*</label>
