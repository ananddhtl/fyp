              ...
              <div class="list-group"><a href="#" class="list-group-item">
               ...
               with font-awesome or any other icon font library -->
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="/addgoodsreceived" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p> Goods Received Entry</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/goodsreceivedlist" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p> Goods Received List</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="/addgoodsreturn" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p> Goods Return Entry</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="/addgoodsissue" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p> Goods Issue Entry</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
