        ...
        <form action="{{route('postProjectActivitiesData')}}" method="POST">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="input-group ">
                            <input type="hidden" class="form-control" name="project_id" id="project_id" value="{{@$project[0]->project_id}}">
                            <input type="text" autocomplete="off" class="form-control" name="projectsearchKey" value="{{@$project[0]->project_name}}" onkeyup="searchProject();" id="projectsearchKey" placeholder="Search Project Name">
                ...
                <div class="form-group row">
                    <div class="col-sm-3">
                        <div class="input-group ">
                            <input type="hidden" class="form-control" name="id" id="id" value="{{@$suppliers[0]->full_name}}">
                            <input type="text" autocomplete="off" class="form-control" name="supplierssearchKey" onkeyup="searchSuppliers();" id="supplierssearchKey" placeholder="Enter Party Name">

                            <span class="input-group-append">
                                <button type="button" data-toggle="modal" data-target="#exampleModal2" class="btn btn-info btn-flat"><i class="fas fa-plus"></i></button>
                            </span>
                        </div>
                    ...
                    <div class="col-sm-3">
                        <div class="input-group ">
                            <input type="hidden" class="form-control" name="activities_id" id="activities_id" value="{{@$activity[0]->activities_title}}">
                            <input type="text" autocomplete="off" class="form-control" name="searchKey" onkeyup="searchActivities();" id="searchKeyForActivity" placeholder="Enter Items Name">
                            <span class="input-group-append">
                    ...
                    <div class="col-sm-2">
                        <input type="number" class="form-control" name="debit" id="debit" onkeyup="changeDebitCredit('debit');" placeholder="Enter Income">
                    </div>
                    <div class="col-sm-2">
                        <input type="number" class="form-control" name="credit" onkeyup="changeDebitCredit('credit');" id="credit" placeholder="Enter Expenses">
                    </div>
                    <div class="col-sm-1">
