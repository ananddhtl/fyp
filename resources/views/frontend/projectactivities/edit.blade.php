      ...
      <div class="card-body">
        ...
        <div class="form-group ">
          <div class="row">
            ...
            <div class="col-sm-4">
              <label for="exampleInputEmail1 " class="col-form-label">Project Title:*</label>
            ...
            <div class="col-sm-4">
              <label for="exampleInputEmail1" class="col-form-label">Project Location:*</label>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-2">
            <input type="number" class="form-control" name="credit" onkeyup="changeDebitCredit('credit');" id="credit" placeholder="Enter Expense">
          </div>
