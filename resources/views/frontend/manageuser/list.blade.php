    ...
    <div class="card card-info">
        ...
        <div style="border-bottom: 2px solid  #eee ;" class="card-body">
            ...
            <div class="form-group row">
                <div class="col-sm-4">
                    <label for="project_name" class=" col-form-label"> Full Name</label>

                    <input type="text" class="form-control" autocomplete="off" name="UserId"
                        value="{{@$users[0]->username}}" id="full_name" placeholder="Enter Full Name" required>
                </div>
                <div class="col-sm-4">
                    <label for="email" class=" col-form-label"> Email</label>

                    <input type="text" class="form-control" autocomplete="off" name="email"
                        value="{{@$users[0]->email}}" id="email" placeholder="Enter Email">
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a style="width:40px" href="{{url('manageuser/'.$item->id)}}"
