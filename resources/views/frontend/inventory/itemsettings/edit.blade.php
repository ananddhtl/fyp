...
<div class="col-md-12 ">
    <div class="card card-info">
        ...
        <form action="{{ url('/updateItemSettingsData',$itemSettings->id) }}" method="POST"
            ...
            <div class="card-body">
                <div class="form-group row">
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control" value="{{$itemSettings->item_name}}" autocomplete="off"
                            name="item_name" id="item_name" placeholder="Enter Item Name" required>
                    </div>
                    <div class="col-sm-4">
                        <label for="title" class=" col-form-label"> Item Details:* </label>
                        <input type="text" class="form-control " value="{{$itemSettings->item_details}}"
                            autocomplete="off" name="item_details" id="item_details" placeholder="Enter Item Details"
                            required>
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control " value="{{$itemSettings->normal_rate}}"
                            autocomplete="off" name="normal_rate" id="normal_rate" placeholder="Enter Normal Rate"
                            required>
                    </div>
                    <div class="col-sm-4">
                        ...
                        @if(!empty($itemSettings->cover_image))
                        <img height="100px" src="{{ $itemSettings->cover_image }}" alt="Current Image">
                        @else
                        <img height="100px;" src="{{asset('image/defaultimage.png')}}" alt="">
                        @endif
                    </div>
                    <div class="col-sm-4">
                        <label for="unit" class=" col-form-label"> Unit:* </label>
                        <input type="text" class="form-control " autocomplete="off" value="{{$itemSettings->unit}}"
                            name="unit" id="unit" placeholder="Enter Unit" required>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-4">
                        <label for="normal_rate" class=" col-form-label"> Unit Value:* </label>
                        <input type="number" class="form-control " autocomplete="off" value="{{$itemSettings->equal}}"
                            name="equals" id="equals" placeholder="Enter Unit Value" required>
                    </div>
                    <div class="col-sm-4">
                        <label for="sub_unit" class=" col-form-label"> Sub Unit* </label>
                        <input type="text" class="form-control " value="{{$itemSettings->subunit}}" autocomplete="off"
                            name="subunit" id="subunit" placeholder="Enter SUb Unit " required>
                    </div>
                    <div class="col-sm-4">
                        <label for="sub_unit_value" class=" col-form-label"> Sub Unit Value:* </label>
                        <input type="text" class="form-control " autocomplete="off"
                            value="{{$itemSettings->equal_value}}" name="equal_value" id="equal_value"
                ...
                <div class="form-group row">
                    <div class="col-sm-3">
                        ...
                        <input type="checkbox" class="form-control " name="vatable" value="1"
                            {{ $itemSettings->vatable ? 'checked' : '' }}>

                    </div>
                    <div class="col-sm-3">
                        <label for="sub_unit" class=" col-form-label"> Discount in percentage* </label>
                        <input type="text" class="form-control " autocomplete="off"
                            value="{{$itemSettings->discount_in_percent}}" name="discount_in_percent"
                            id="discount_in_percent" placeholder="Discount %">
                    </div>
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-control " autocomplete="off" name="sellrate" id="sellrate"
                            value="{{$itemSettings->sellrate}}" placeholder="Enter Sell Rate" required>
                    </div>
                    <div class="col-sm-3">
                        ...
                        <input type="checkbox" class="form-control " name="stockable" value="1"
                            {{ $itemSettings->stockable ? 'checked' : '' }}>
                    </div>
                </div>
            </div>
