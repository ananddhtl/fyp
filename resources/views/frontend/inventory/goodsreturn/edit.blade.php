...
<div class="col-md-12 ">
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">Goods Return </h3>
        ...
        <form action="{{ url('/updateGoodsReturn', $goodsReturn->tCode) }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="form-group row">
                    <div class="col-sm-4">
                        ...
                        <input name="date" class="form-control" type="date" id="billDate"
                            value="{{ $goodsReturn->date }}" placeholder="Date" readonly>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" autocomplete="off" class="form-control" id="partyBillNo" name="partyBillNo"
                            placeholder="Bill No." value="{{ $goodsReturn->partyBillNo }}" readonly>
                    </div>
                </div>
