...
<div class="col-md-12 ">
    <div class="card card-info">
        ...
        <form action="{{ url('/updategoodsIssueReturn', $goodsIssueReturn->transactionCode) }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="form-group row">
                    <div class="col-sm-4">
                        ...
                        <input name="date" class="form-control" type="date" id="billDate"
                            value="{{ $goodsIssueReturn->date }}" placeholder="Date" readonly>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" autocomplete="off" class="form-control" id="partyBillNo" name="partyBillNo"
                            placeholder="Bill No." value="{{ $goodsIssueReturn->demand_sheet_number }}" readonly>
                    </div>
                </div>
