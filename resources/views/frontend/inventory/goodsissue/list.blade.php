                ...
                <table class="table  table-hover text-nowrap" id="mytable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$item->demand_sheet_number}}</td>
                            <td>{{$item->quantity}}</td>
                            <td>{{$item->vat}}</td>
                            <td>{{$item->gtotal}}</td>
                            <td><a href="{{url('editgoodIssue/'.$item->transactionCode)}}"><button
                                        class="btn btn-info">Cancel<i class="ri-pencil-line"></i>
                                    </button></a>&nbsp;<button class="btn btn-info openrecord-button"
